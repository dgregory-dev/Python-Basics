# Create the class Book as an object
class Book:
...
# Create the class library as an array to hold the books
class Library:
    def __init__(self):
        self.books = []
    ...
    def update_availability(self, title, available):
        ...
        update_book = lambda book: setattr(book, 'available',
                                           available) if book.title.lower() == title.lower() else None
